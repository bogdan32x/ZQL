...
public class SimpleCharStream {
	 ...
	 * Magic number 4096.
	 */
	private static final int	MAGIC_NUMBER_4096	= 4096;

	/**
	 * Magic number 2048.
	 */
	private static final int	MAGIC_NUMBER_2048	= 2048;
	 ...
	 * Table size.
	 */
	private int					tabSize				= SimpleCharStream.EIGHT;
	...
	protected void expandBuffer(final boolean wrapAround) {
		final char[] newbuffer = new char[this.bufsize + SimpleCharStream.MAGIC_NUMBER_2048];
		final int[] newbufline = new int[this.bufsize + SimpleCharStream.MAGIC_NUMBER_2048];
		final int[] newbufcolumn = new int[this.bufsize + SimpleCharStream.MAGIC_NUMBER_2048];
		...
		this.bufsize += SimpleCharStream.MAGIC_NUMBER_2048;
	...
	protected void fillBuff() throws IOException {
		if (this.maxNextCharInd == this.available) {
			if (this.available == this.bufsize) {
				if (this.tokenBegin > SimpleCharStream.MAGIC_NUMBER_2048) {
					this.bufpos = SimpleCharStream.MAGIC_NUMBER_0;
					this.maxNextCharInd = SimpleCharStream.MAGIC_NUMBER_0;
				...
				if (this.available > this.tokenBegin) {
					...
					if ((this.tokenBegin - this.available) < SimpleCharStream.MAGIC_NUMBER_2048) {
	...
	public SimpleCharStream(final Reader dstream, final int startline, final int startcolumn) {
		this(dstream, startline, startcolumn, SimpleCharStream.MAGIC_NUMBER_4096);
	}
	...
	public SimpleCharStream(final Reader dstream) {
		this(dstream, 1, 1, SimpleCharStream.MAGIC_NUMBER_4096);
	}
	...
	public void reInit(final Reader dstream, final int startline, final int startcolumn) {
		this.reInit(dstream, startline, startcolumn, SimpleCharStream.MAGIC_NUMBER_4096);
	}
	...
	public void reInit(final Reader dstream) {
		this.reInit(dstream, 1, 1, SimpleCharStream.MAGIC_NUMBER_4096);
	}
	...
	public SimpleCharStream(final InputStream dstream, final String encoding, final int startline, final int startcolumn) throws UnsupportedEncodingException {
		this(dstream, encoding, startline, startcolumn, SimpleCharStream.MAGIC_NUMBER_4096);
	}
	...
	public SimpleCharStream(final InputStream dstream, final String encoding) throws UnsupportedEncodingException {
		this(dstream, encoding, 1, 1, SimpleCharStream.MAGIC_NUMBER_4096);
	}
	...
	public void reInit(final InputStream dstream, final String encoding) throws UnsupportedEncodingException {
		this.reInit(dstream, encoding, 1, 1, SimpleCharStream.MAGIC_NUMBER_4096);
	}
	...
	public void reInit(final InputStream dstream, final String encoding, final int startline, final int startcolumn)
			throws UnsupportedEncodingException {
		this.reInit(dstream, encoding, startline, startcolumn, SimpleCharStream.MAGIC_NUMBER_4096);
	}

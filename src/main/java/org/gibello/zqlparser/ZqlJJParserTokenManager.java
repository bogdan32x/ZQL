...
protected Token jjFillToken()
{
   ...
   t.setKind(jjmatchedKind);
   String im = jjstrLiteralImages[jjmatchedKind];
   t.setImage((im == null) ? input_stream.getImage() : im);
   t.setBeginLine(input_stream.getBeginLine());
   t.setBeginColumn(input_stream.getBeginColumn());
   t.setEndLine(input_stream.getEndLine());
   t.setEndColumn(input_stream.getEndColumn());
   return t;
}
